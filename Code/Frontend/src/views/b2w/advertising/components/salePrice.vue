<template>
  <el-dialog :title="'设置促销价'" v-dragMove :visible="open" :before-close="onClose" width="600px" v-loading="loading" :close-on-press-escape="false" :close-on-click-modal="false">
  ...
  export default {
    data() {
      ...
      return {
        ...
        rules: {
          price: [
            { required: true, message: '输入的促销价最多保留两位小数', trigger: 'blur' },
