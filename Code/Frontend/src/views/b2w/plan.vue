  ...
  <div>
    ...
    <div class="header-box">
      <el-form ref="listQuery" :inline="true" :model="listQuery" class="demo-form-inline" size="mini">
        ...
        <el-form-item label="操作人" prop="user_name">
          <el-input v-model="listQuery.user_name" size="mini" placeholder="请输入操作人"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column prop="istore_account_name" label="Site Code" width="220"></el-table-column>
        ...
        <el-table-column class="type" prop="type"
                         ...
                         column-key="type"
                         width="120"
                         :filters="[{ text: '计划上传', value: 0 }, { text: '计划下架', value: 1 }, { text: 'copy广告', value: 2 }]"
        ...
        >
          <template slot-scope="scope">
            ...
            <el-tag type="danger" size="small" v-else-if="Number(scope.row.type) === 2">copy广告</el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="status"
                         ...
                         column-key="status"
                         width="120"
                         :filters="[{ text: '执行中', value: 10 }, { text: '执行出错', value: 20 }, { text: '执行成功', value: 30 }]"
...
<script>
import { getPlan, getSelectAll } from '@/api/b2w'
...
export default {
  ...
  data() {
    return {
      permissions: {
        plan_AddThePlan: 'b2w.product-plan.product-plan.add',//添加计划按钮
        plan_PlanDetails: 'b2w.product-plan.product-plan.plan-log'//详情
      },//权限
  ...
  methods: {
    ...
    addPlan() {
      this.addPlanDialogOption = {
        open: true,
        options: this.mulOptions.b2wAdvtAccount
      }
    },
    getPlanDetails(data) {
