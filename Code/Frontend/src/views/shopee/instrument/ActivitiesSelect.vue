  ...
  <div>
    ...
    <div class="header-box" ref="headerBox">
      ...
      <el-row class="right-row">
        <el-button size="mini" type="primary" class="el-icon-circle-plus-outline" @click="searchReport" v-permission="permissions.exportShelvesAdvt_add">添加选品任务</el-button>
      </el-row>
    </div>
    <!-- 列表 -->
    <div class="content-box">
      ...
      >
        ...
        <el-table-column prop="username" label="操作人" min-width="120" align="center"></el-table-column>
        <el-table-column label="导出时间段" align="center" min-width="200">
          <template slot-scope="scope">
            {{ scope.row.start_time }} 至 {{ scope.row.end_time }}
          </template>
        </el-table-column>
        <el-table-column prop="create_time" label="任务创建时间" align="center" min-width="150">
        ...
        <el-table-column label="详情" prop="message" align="center" min-width="300"></el-table-column>
...
<script>
import { addPlanAccount, selectionList } from '@/api/shopee'
import addForm from './ActivitiesSelect/addform'
...
export default {
  ...
  data() {
    return {
      permissions: {
        exportShelvesAdvt_add: 'shopee.export.selection.add'//添加
      },//权限
      listQuery: {
        page: 1,
        per_page: 10,
