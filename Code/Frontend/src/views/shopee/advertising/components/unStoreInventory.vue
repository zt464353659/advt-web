<template>
  <el-dialog :title="'取消店铺指定库存'" v-dragMove :visible="open" :before-close="onClose" width="600px" v-loading="loading" :close-on-press-escape="false" :close-on-click-modal="false">
...
<script>
  import { unStoreInventory } from '@/api/shopee'
