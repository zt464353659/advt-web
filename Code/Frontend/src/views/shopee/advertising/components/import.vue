<template>
  <el-dialog :title="'导入'" :visible="open" :before-close="onClose" width="600px" v-dragMove>
...
<script>
  ...
  import { exportLongTile, exportLongDescription } from '@/views/shopee/export'
  import { importExcelData, importFormatData } from '@/api/shopee'
  ...
  export default {
    ...
    created() {
      ...
      this.uploadAction = base_api + 'shopee/advt/upload/file'
    },
    methods: {
      onClose() {
