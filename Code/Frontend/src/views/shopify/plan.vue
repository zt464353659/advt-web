    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column prop="status"
                         ...
                         width="100"
                         align="center"
                         :filters="[{ text: '未执行', value: 10 }, { text: '执行出错', value: 20 }, { text: '执行成功', value: 30 }]"
        ...
        <el-table-column prop="user_name" label="操作人" width="70"></el-table-column>
        <el-table-column prop="create_time" label="操作时间" width="150" sortable :sort-method="(a,b) => a-b"></el-table-column>
...
<script>
import { getPlan } from '@/api/shopify'
...
export default {
  ...
  data() {
    return {
      permissions: {
        plan_AddThePlan: 'shopify.advt.product-upload-plan.add',//添加计划按钮
        plan_PlanDetails: 'shopify.advt.product-upload-plan.info'//详情
      },//权限
