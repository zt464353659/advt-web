    ...
    <el-form size="small" :inline="true" class="form-search">
      <el-form-item label="操作类型">
        <el-select v-model="operateType" clearable placeholder="请选择" style="width: 120px;">
          <el-option v-for="item in operateTypeArr" :key="item.value" :label="item.value" :value="item.label"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-tabs v-model="activeName" type="card" @tab-click="tabClick">
        <el-tab-pane label="系统日志" name="first">
          ...
          >
            ...
            <el-table-column prop="update_time" label="操作时间" width="140">
              <template slot-scope="scope">
        ...
        <el-tab-pane label="操作日志" name="second">
          ...
          >
            ...
            <el-table-column prop="istore_product_id" label="istore Product ID" width="140"></el-table-column>
            <el-table-column prop="operate_type" label="操作类型" width="70"></el-table-column>
            <el-table-column prop="operate" label="操作" width="70"></el-table-column>
            <el-table-column prop="column" label="编辑字段" width="80"></el-table-column>
            ...
            <el-table-column prop="operate_status" label="操作结果" width="80"></el-table-column>
            <el-table-column prop="reason" label="失败原因" min-width="100"></el-table-column>
            <el-table-column prop="user_name" label="操作人" width="80"></el-table-column>
            <el-table-column prop="update_time" label="操作时间" width="140">
              <template slot-scope="scope">
                {{ scope.row.update_time ? scope.row.update_time : scope.row.create_time }}
              </template>
...
import { getChangeLog } from '@/api/kr11street'
...
export default {
    ...
    return {
      ...
      spanRule: {
        rule: {
          ...
          7: ['id', 'istore_product_id', 'operate', 'error_message'],
  ...
  methods: {
    tabClick() {
      ...
      this.systemListQuery.log_type = this.operateType
      this.operationListQuery.result_status = this.resultStatus
      this.operationListQuery.log_type = this.operateType
    },
    search() {
