...
<script>
  ...
  export default {
    name: 'SingleDetails',
    components: { PictureView, Tinymce },
    data() {
      return {
        permissions:{
    ...
    methods: {
      ...
      noUpdate() {
        ...
        if (this._.isEqual(copyData, this.cloneData) && this._.isEqual(this.pic_list,this.pictureList)) {
        ...
        return this._.isEqual(copyData, this.cloneData) && this._.isEqual(this.pic_list,this.pictureList)
      },
      // 编辑保存
      saveAdvt() {
        // 无空值且已修改
