  ...
  <div>
    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column prop="site_code" label="Site Code" width="140"></el-table-column>
        ...
        <el-table-column class="type" prop="type" label="类型" width="100" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column prop="status"
                         ...
                         width="100"
                         align="center"
                         :filters="[{ text: '未执行', value: 10 },{ text: '执行中', value: 15 }, { text: '执行出错', value: 20 }, { text: '执行成功', value: 30 }]"
                         :filter-method="filterStatus"
                         filter-placement="bottom-start"
        >
          <template slot-scope="scope">
            <el-tag type="info" size="small" v-if="Number(scope.row.status) === 10">未执行</el-tag>
            <el-tag type="primary" size="small" v-if="Number(scope.row.status) === 15">执行中</el-tag>
...
export default {
  ...
  data() {
    return {
      permissions: {
        plan_AddThePlan: 'rueducommerce.advt.plan.add',//添加计划按钮
        plan_PlanDetails: 'rueducommerce.advt.plan.info'//详情
      },//权限
