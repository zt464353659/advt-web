...
-->
        ...
        <el-collapse-item title="Commodity information" name="2">
          ...
          >
            ...
            <el-row>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item label="istore Product ID">
                  <p>{{ editForm.istore_product_id }}</p>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item label="运输方式">
                  <p>{{ editForm.shipping_method }}</p>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item :label="`运费(CNY)`">
                  <p>{{ editForm.shipping_costs }}</p>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item :label="`保本价(${editForm.currency_code})`">
                  <p>{{ editForm.base_price }}</p>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item :label="`售价(${editForm.currency_code})`">
                  <p>{{ editForm.discount_price }}</p>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item :label="`原价(${editForm.currency_code})`">
                  <p>{{ editForm.discount_price }}</p>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item label="毛利率(%)">
                  <p>{{ editForm.gross_margin }}</p>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item label="打包费(CNY)">
                  <p>{{ editForm.parcel_processing_fee }}</p>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item label="汇率">
                  <p>{{ editForm.currency_rate }}</p>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="12" :lg="12">
                <el-form-item label="平台佣金率(%)">
                  <p>{{ editForm.commission }}</p>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-form-item label="描述" prop="description" class="no-back-ground">
              <template v-if="is_edit">
                <tinymce
    ...
    <!--        &lt;!&ndash;日志&ndash;&gt;-->
    <!--        <istoreLogs v-bind.sync="logOptions"></istoreLogs>-->
  </div>
</template>
<script>
import Tinymce from '@/components/Tinymce'
import editImage from './component/editImage'
//import istoreLogs from '../components/istoreLog'
