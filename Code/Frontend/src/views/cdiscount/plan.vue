  ...
  <div>
    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column prop="create_time" label="操作时间" width="150" sort-by="create_time" sortable>
        </el-table-column>
    ...
    <!--添加计划弹窗dialog-->
    <add-form v-bind.sync="addPlanDialogOption" @reload="Listupdate"></add-form>
    <!--计划执行详情弹窗dialog-->
...
<script>
import { fetchPlanList, getSelectAll } from '@/api/cdiscount'
