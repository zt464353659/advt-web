<template>
  ...
  >
    <template>
      <el-form ref="formData" :rules="rules" :model="formData" label-width="120px" size="mini" @submit.native.prevent>
        <el-form-item label="Site code" prop="site_code">
          <el-select v-model="formData.site_code" multiple collapse-tags style="width: 240px">
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" v-debounce @click="setPlanTask">确 定</el-button>
    </span>
  </el-dialog>
</template>

<script>
import { getSelectAll, createFollowAdd } from '@/api/priceminister'
    ...
    setPlanTask() {
      this.$refs['formData'].validate(valid => {
        if (valid) {
          ...
          createFollowAdd(queryParams).then(res => {
