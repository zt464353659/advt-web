  ...
  <div>
    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column prop="site_code" label="Site Code" width="130"></el-table-column>
        ...
        <el-table-column prop="data" label="类型" width="80" align="center">
          <template slot-scope="scope">
...
<script>
import { fetchPlanList, getSelectAll } from '@/api/priceminister'
