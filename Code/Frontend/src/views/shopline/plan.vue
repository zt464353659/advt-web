  ...
  <div>
    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column class="type" prop="type" label="类型" width="120">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" width="80" align="center">
          <template slot-scope="scope">
            <el-button v-if="Number(scope.row.status) !== 10" type="text" size="mini" @click="getPlanDetails(scope.row)">详情</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页-->
...
<script>
  import { fetchPlanList } from '@/api/shopline'
