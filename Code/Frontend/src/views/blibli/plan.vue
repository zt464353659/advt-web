  ...
  <div>
    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column class="type" prop="type" label="类型" width="80">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" width="80" align="center">
          <template slot-scope="scope">
            <el-button v-if="Number(scope.row.status) !== 10"
                       type="text"
                       size="mini"
                       @click="getPlanDetails(scope.row)"
                       v-permission="permissions.plan_PlanDetails"
            >
              详情
            </el-button>
          </template>
...
<script>
import { getPlan } from '@/api/blibli'
...
export default {
  ...
  data() {
    return {
      permissions: {
        plan_AddThePlan: 'blibli.advt.product-upload-plan.add',//添加计划按钮
        plan_PlanDetails: 'blibli.advt.product-upload-plan.info'//详情
      },//权限
