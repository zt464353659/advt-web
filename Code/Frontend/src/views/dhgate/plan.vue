...
<script>
import { fetchPlanList, getSelectAll } from '@/api/dhgate'
...
export default {
  ...
  data() {
    return {
      permissions: {
        plan_AddThePlan: 'dhgate.platform.product-upload-plan.add',//添加计划按钮
        plan_PlanDetails: 'dhgate.platform.product-upload-plan.info'//详情
      },//权限
      ...
      options: {},
      /* 上传计划搜索条件列表 */
      selectOptions: ['DhgateAdvtAccount']
    }
  },
  created() {
    this.getList()
