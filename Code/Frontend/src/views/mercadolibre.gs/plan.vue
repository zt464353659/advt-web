  ...
  <div>
    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column prop="account" width="220">
        ...
        <el-table-column prop="data" label="产品ids" min-width="200">
          <template slot="header">
            <span style="width: 100%;display: inline-block;text-align: center;">产品ids</span>
          </template>
        ...
        <el-table-column prop="create_time" label="操作时间" width="180" sort-by="create_time" sortable align="center"></el-table-column>
...
<script>
import { fetchPlanList } from '@/api/mercadolibre.gs'
...
export default {
  ...
  data() {
    return {
      permissions: {
        plan_AddThePlan: 'mercadolibre.plan.product-plan.add',//添加计划按钮
        plan_PlanDetails: 'mercadolibre.plan.product-plan.info'//详情
      },//权限
