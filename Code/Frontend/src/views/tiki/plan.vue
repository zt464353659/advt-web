  ...
  <div>
      ...
      <el-form ref="listQuery" :inline="true" :model="listQuery" class="demo-form-inline" size="mini">
        <el-form-item label="Site Code" prop="accountId">
          <el-select v-model="listQuery.accountId" clearable placeholder="请选择账号">
            <el-option v-for="item in options.TikiAdvtAccount" :key="item.id" :label="item.account" :value="item.id"></el-option>
          </el-select>
        </el-form-item>
    ...
    <div class="content-box">
      ...
      >
        ...
        <el-table-column prop="account" label="Site Code" width="120" align="center"></el-table-column>
...
<script>
  import { fetchPlanList, getSelectAll } from '@/api/tiki'
  ...
  export default {
    ...
    data() {
      return {
        permissions:{
          plan_AddThePlan:"tiki.platform.product-upload-plan.add",//添加计划按钮
          plan_PlanDetails:"tiki.platform.product-upload-plan.info"//详情
        },//权限
