<template>
  <div>
    ...
    <!--内容区-->
    <div class="content-box detail-form" style="padding-top: 0" :key="formKey">
        ...
        <el-collapse-item title="Listing Information" name="1">
          ...
          >
            <el-row>
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="24">
                <el-form-item v-if="isEdit && canEdit" prop="category" label="选择新目录" class="no-back-ground">
                  <el-cascader
                    placeholder="请选择目录"
                    :props="categoryProps"
            ...
            <el-form-item label="主图" prop="images" class="is-required-attr">
              <template>
                <edit-image
                  v-if="isEdit && canEdit"
            ...
            <el-form-item label="Product Top Features" prop="note">
              <div class="no-back-ground" v-if="isEdit && canEdit">
                ...
                <div style="margin-top:2px;" class="tip pt-5"><i class="el-icon-info"></i>请输入英语</div>
              </div>
              <div v-else class="text-wrap">{{ cloneData.note }}</div>
            </el-form-item>
            <el-form-item label="Product Description" prop="description" class="is-required-attr">
              <tinymce
                v-if="isEdit && canEdit"
            ...
            <el-collapse-item :title="`${String(item.istore_product_id)} ${item.name ? `[${item.name}]` : ''}`" :name="index" v-for="(item, index) in cloneData.product_info" :key="index">
              ...
              >
                <el-row>
                  ...
                  <el-col :xs="24" :sm="24" :md="12" :lg="12">
                    <el-form-item :label="`Base Price(${item.currency_code})`">
                      <p>{{ item.base_price }}</p>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="12" :lg="12">
                  ...
                  <el-col :xs="24" :sm="24" :md="12" :lg="12">
                    <el-form-item label="Product Dimensions(cm)">
                      <p>{{ `${ item.length } × ${ item.width } × ${ item.high }` }}</p>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="12" :lg="12">
                    <el-form-item label="packing Dimensions(cm)">
                      <p>{{ `${ item.package_length } × ${ item.package_width } × ${ item.package_high }` }}</p>
                    </el-form-item>
                  </el-col>
                  ...
                  <!--                            <el-input v-model="item.package_length" size="mini" style="width:50%;"></el-input>-->
                  <!--                          </el-form-item>-->
                  <!--                        </el-col>-->
                  <!--                        <el-col :xs="24" :sm="24" :md="8" :lg="8">-->
                  <!--                          <el-form-item style="margin-bottom: 0" label="宽" :inline="true" prop="package_width" label-width="50px">-->
                  <!--                            <el-input v-model="item.package_width" size="mini" style="width: 50%;margin-left: 10px;"></el-input>-->
                  <!--                          </el-form-item>-->
                  <!--                        </el-col>-->
                  <!--                        <el-col :xs="24" :sm="24" :md="8" :lg="8">-->
                  <!--                          <el-form-item style="margin-bottom: 0" label="高" :inline="true" prop="package_high" label-width="50px">-->
                  <!--                            <el-input v-model="item.package_high" size="mini" style="width: 50%;margin-left: 10px;"></el-input>-->
                  <!--                          </el-form-item>-->
                  <!--                        </el-col>-->
                  <!--                      </el-row>-->
                  <!--                    </el-form-item>-->
                  ...
                  <el-col :xs="24" :sm="24" :md="12" :lg="12">
                    <el-form-item label="Shipping Method">
                      <p>{{ item.shipping_method || '无' }}</p>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="12" :lg="12">
                    <el-form-item :label="`Shipping Costs(${item.currency_code})`">
                  ...
                  <!--vari区分项-->
                  <!-- var区分项和属性值信息是一个值 -->
                  <template v-for="(v,k) in item.attributes">
                    <el-col :xs="24" :sm="24" :md="12" :lg="12" v-if="v.key !== 'dimensions' && v.key !== 'product_top_features'" :key="k">
          ...
          arr.push({
            ...
            content: v.images.map(v1 => {
              return {
                ...
                product_image_thumb: v1.product_image_thumb ? v1.product_image_thumb : v1.image_path
              }
            })
          })
        })
