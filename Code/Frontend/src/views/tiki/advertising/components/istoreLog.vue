        ...
        <el-tab-pane label="操作日志" name="second">
          ...
          <div class="pagination-container">
            <el-pagination
              ...
              :page-sizes="[10,20,40]"
              :page-size="ULogListQuery.per_page"
...
import { getChangeLog } from '@/api/tiki'
...
export default {
  ...
  methods: {
    ...
    ULogRenderList() {
      ...
      console.log(this.ULogListQuery, queryParams)
      queryParams.status = this.status
      queryParams.advtId = this.advtId
      queryParams.type = 2
      getChangeLog(queryParams).then((res) => {
        ...
        // index 、istore_product_id、type、operate_type、edit_field、sub_product_id、content、result_status、reason、user_name、update_time
